...
* 
*/
class Promobio extends Custom_CI_Controller
{
	...
	public function index(){
		...
		$data["view_user"] = $this->User_model->get_all_promobio();


		$this->load->view("promobio_view.php",$data);
	}			

	public function Delete(){
		$this->load->model("User_model");
		$req = $this->input->get("d");
		$this->User_model->delete_promo($req);

		redirect(site_url("promobio"));
	}
    ...
    public function sendNotifPKS()
    {
    	...
    	foreach ($users as $u) {
    		$param = array("name" => $u->employee_name, 
						   "no_pks" => $u->no_pks,
