...
* 
*/
class Events extends Custom_CI_Controller
{
	...
	public function index(){
		...
		$data = array();
		$data["temp"] = $req;
		$data['view_type'] = $this->Event_model->get_all_type();
	...
	public function add_type_view(){
		...
		$data=array();
		$this->load->view("Add_events_view",$data);
	}
	...
	public function add_type(){
		...
		$imageindex = $this->Event_model->get_index();
		$dates = date("Y-m-d h:i:s");
		$url_link = $this->input->post("url_link");
		$active = $this->input->post("active");

		$data = array(
			'events_name' => $this->security->xss_clean($imagetitle),
			'events_desc' => $this->security->xss_clean($content),
			'events_index' => $imageindex,
		...
		if(!empty($_FILES['imagepath']['name'])){
			...
			$data["events_img"] = $file['file_name'];
		}
	...
	public function update(){
		...
		$data["req"] = $req;
		$data["viewProduct"] = $this->Event_model->get_type_by_id($req);
	...
	public function update_type(){
		...
		$this->Event_model->update($sliderID,$data);
		redirect(site_url("Events"));
	}
	...
	function move_client_up()
	{
			...
			$query = $this->Event_model->index_up($clientid, $index);
	...
	function move_client_down()
	{
			...
			$query = $this->Event_model->index_down($clientid, $index);
