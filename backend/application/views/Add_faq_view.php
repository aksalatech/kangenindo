...
<head>
  ...
  <title><?php echo APP_NAME; ?> | FAQ List</title>
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
              ...
              <div class="d-flex align-items-center flex-wrap">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                  ...
                  <li class="breadcrumb-item">
                    <a href="<?php echo base_url() ?>Kabkot" class="text-muted"> FAQ List</a>
                  </li>
                </ul>
                <!--end::Breadcrumb-->
              </div>
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <?php
                  if (isset($req)) {
                  ?> <form method="POST" action="<?php echo base_url(); ?>Frequent/update_type">
                      ...
                      <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="card-body">
                          ...
                          ?>
                            <div class="form-group row">
                              <div class="col-lg-6">
                                ...
                                <div class="row">
                                  <input type="text" class="form-control col-md-11" name="faq_title" id="faq_title" value="<?php echo $key->faq_title; ?>" required>
                                </div>
                              </div>
                               <div class="col-lg-6">
                              <label>FAQ Answer:</label>
                              <div class="row">
                              <textarea class="form-control" id="faq_desc" name="faq_desc" rows="4" cols="50"><?php echo $key->faq_desc; ?></textarea>
                                </div>
                            </div>
                          </div>
                          <div class="form-group row">
                          <div class="col-lg-8">
                              <label>Type:</label>
                              <div class="row">
                                  <select id="faqtype" name="faqtype" class="form-control col-md-11">
                                      <option value="FAQ" <?php echo ($key->faq_type == "FAQ") ? "selected" : "" ?>>FAQ</option>
                                      <option value="Franchise" <?php echo ($key->faq_type == "Franchise") ? "selected" : "" ?>>Franchise</option>
                                  </select>
                                </div>
                            </div>
                  ...
                  ?>
                    <form method="POST" action="<?php echo base_url(); ?>Frequent/add_type">
                      <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header d-flex justify-content-center">
                        ...
                        <div class="form-group row">
                              <div class="col-lg-6">
                                <label>FAQ Question</label>:
                                <div class="row">
                                  <input type="text" class="form-control col-md-11"  name="faq_title" id="faq_title"  required>
                                </div>
                              </div>
                               <div class="col-lg-6">
                              <label>FAQ Answer:</label>
                              <div class="row">
                              <textarea class="form-control" id="faq_desc" name="faq_desc" rows="4" cols="50"></textarea>
                                </div>
                            </div>
                          </div>
                          <div class="form-group row">
