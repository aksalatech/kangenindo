...
<body id="bd_faqView" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                            ...
                            <div class="card card-custom">
                                <div class="card-header flex-wrap py-5">
                                    <div class="card-title">
                                        <h3 class="card-label">Banner Home List Table
                                    </div>
                                    <div class="card-toolbar">
                                        <!--begin::Button-->
                                        <a href="<?php echo base_url(); ?>banner/add_type_view" class="btn btn-primary font-weight-bolder">
                                    ...
                                    <table id="ProductTable" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="280px">Content</th>
                                                <th width="100px">Small Image</th>
                                                <th width="90px">Banner Image</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() ?>./../images/banner/<?php echo $value->img_small ?>" target="_blank">
                                                            <img src="<?php echo base_url() ?>./../images/banner/<?php echo $value->img_small ?>" width="100px" />
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="<?php echo base_url() ?>./../images/banner/<?php echo $value->img_banner ?>" target="_blank">
                                                            <img src="<?php echo base_url() ?>./../images/banner/<?php echo $value->img_banner ?>" width="100px" />
                                                        </a>
                                                    </td>
                                                    <td><a href="<?php echo $value->link ?>" target="_blank"><?php echo $value->link; ?></a></td>
                                                    <td>
                                                        <input type="checkbox" disabled <?php echo ($value->active == 1) ? "checked" : "" ?> />
                                                    </td>
                                                    <td align="center">
                                                        <a href="<?php echo base_url(); ?>Banner/update?typeID=<?php echo $value->id_banner; ?>" class="btn btn-sm btn-warning btn-text-warning btn-icon mr-2 mb-1" title="Update Data"><i class="fas fa-pencil-alt"></i> </a>
                                                        <a href="#" type="button" class="btn btn-sm btn-danger btn-text-danger btn-icon mr-2 mb-1" name="deleteButton" id="deleteButton" onclick="confirmation('<?php echo $value->id_banner; ?>')" title="Delete Data"><i class="fas fa-trash-alt"></i></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
    ...
    <script type="text/javascript">
        ...
        function confirmation(d) {
            var base = base_url + "Banner/delete?typeID=" + d;
            //alert(base)
