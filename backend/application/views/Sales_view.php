...
<head>
    ...
    <title><?php echo APP_NAME; ?> | Sales By Stores</title>
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            ...
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
                        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-2">
                                <h5 class="text-dark font-weight-bold my-1 mr-5">Sales By Stores</h5>
                            </div>
                            <div class="d-flex align-items-center flex-wrap">
                                ...
                                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?php echo base_url() ?>kabkot" class="text-muted"> Sales By Stores</a>
                                    </li>
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                    ...
                    <!--end::Subheader-->
                    <!--begin::Entry-->
                    <form id="productView" method="POST" action="<?php echo base_url() ?>Sales/bystore">
                                ...
                                <div class="card card-custom">
                                    <div class="card-header flex-wrap py-5">
                                        <div class="card-title">
                                            <h3 class="card-label">Sales By Stores Table
                                        </div>
                                    ...
                                    <div class="card-header flex-wrap py-5">
                                        <div class="card-toolbar">
                                            ...
                                            <select name="brancOption" onchange="doit()" id="brancOption">
                                                ...
                                                ?>
                                                    <option <?php echo ($temp == $key->brand_name) ? "selected" : ""; ?> value="<?php echo $key->brand_name ?>"><?php echo $key->brand_name ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
