                ...
                <div class="card-body">
                  ...
                  <table id="ProductTable" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th width="30px">No.</th>
                        <th width="120px">Nama Event</th>
                        <th width="120px">Tanggal Absensi</th>
                        ...
                        <th width="125px">Lokasi</th>
                        <th width="100px">Negrara</th>
                        <th width="120px">Maps</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php echo $value->att_type; ?></td>
                          <td><?php echo date("d M Y H:i:s", strtotime($value->absence_date)); ?></td>
                          ...
                          <td>
                            <a href="https://www.google.com/maps?q=<?php echo $value->latitude ?>,<?php echo $value->langitude ?>" target="_blank">View Maps</a>
                          </td>
                        </tr>
                      <?php
                      }
