<!-- Modal Dialog -->
<div class="modal fade" id="dialog-simple" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table class="table">
          <tr>
            ...
            <td>
              <select id="cbpt" name="cbpt" class="form-control" style="opacity: 1">
      ...
      <div class="modal-footer">
        <strong id="loading-simple" style="display: none">Now Loading..</strong>
        <button type="button" id="btsimple" class="btn btn-success"><span class="glyphicon glyphicon-print"></span> &nbsp; Print Data</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->