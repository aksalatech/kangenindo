...
<head>
  ...
  <title><?php echo APP_NAME; ?> | Daftar Kab/Kota</title>
          ...
          <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
              ...
              <div class="d-flex align-items-center flex-wrap mr-2">
                <h5 class="text-dark font-weight-bold my-1 mr-5">Daftar Kab/Kota</h5>
              </div>
              <div class="d-flex align-items-center flex-wrap">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                  ...
                  <li class="breadcrumb-item">
                    <a href="<?php echo base_url() ?>Kabkot" class="text-muted"> Daftar Kab/Kota</a>
                  </li>
                </ul>
                <!--end::Breadcrumb-->
              </div>
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <?php
                  if (isset($req)) {
                  ?> <form method="POST" action="<?php echo base_url(); ?>Kabkot/update_type">
                      <input type="hidden" name="catID" id="catID" value="<?php echo $req ?>">
                      <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header d-flex justify-content-center">
                          <h3 class="card-title">Pendaftaran Kab/Kota</h3>
                        </div>
                        <!--begin::Form-->
                        <?php
                        if (isset($err)) {
                        ...
                        <div class="card-body">
                          ...
                          ?>
                            <div class="form-group row">
                              <div class="col-lg-6">
                                ...
                                <div class="row">
                                  <input type="text" class="form-control col-md-11" readonly name="kabkot_id" id="kabkot_id" value="<?php echo $key->kabkot_id; ?>" required>
                                </div>
                              </div>
                               <div class="col-lg-6">
                              <label>Nama Provinsi:</label>
                              <div class="row">
                                <select id="prov_id" name="prov_id" class="form-control col-md-11">
                                  <?php foreach ($provList as $p) { ?>
                                    <option value="<?php echo $p->prov_id ?>" <?php echo ($p->prov_id == $key->prov_id) ? "selected" : "" ?>><?php echo $p->prov_name ?></option>
                                  <?php } ?>
                                </select>
                              </div>
                            </div>
                          ...
                          <div class="form-group row">
                            <div class="col-lg-6">
                              ...
                              <div class="row">
                                <input type="text" class="form-control col-md-11" name="kabkot_name" id="kabkot_name" value="<?php echo $key->kabkot_name; ?>" required>
                              </div>
                            </div>
                             <div class="col-lg-6">
                              <label>Kab/Kota:</label>
                              <div class="row">
                                <input type="text" class="form-control col-md-11" name="kab_kota" id="kab_kota" value="<?php echo $key->kab_kota; ?>" required>
                              </div>
                            </div>
                          </div>
                          <div class="form-group row">
                  ...
                  ?>
                    <form method="POST" action="<?php echo base_url(); ?>Kabkot/add_type">
                      <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header d-flex justify-content-center">
                          <h3 class="card-title">Pendaftaran Daftar Kab/kota</h3>
                        </div>
                        <div class="card-body">
                          <div class="form-group row">
                              <div class="col-lg-6">
                                <label>Kode Kab/Kota</label>:
                                <div class="row">
                                  <input type="text" class="form-control col-md-11" name="kabkot_id" id="kabkot_id" required>
                                </div>
                              </div>
                               <div class="col-lg-6">
                              <label>Nama Provinsi:</label>
                          ...
                          <div class="form-group row">
                            <div class="col-lg-6">
                              <label>Nama Kab/Kota:</label>
                              <div class="row">
                                <input type="text" class="form-control col-md-11" name="kabkot_name" id="kabkot_name" required>
                              </div>
                            </div>
                             <div class="col-lg-6">
                              <label>Kab/Kota:</label>
                              <div class="row">
                                <input type="text" class="form-control col-md-11" name="kab_kota" id="kab_kota" required>
                              </div>
                            </div>
                          </div>
                          <div class="form-group row">
