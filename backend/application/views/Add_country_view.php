            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
              ...
              <div class="d-flex align-items-center flex-wrap">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                  ...
                  <li class="breadcrumb-item">
                    <a href="<?php echo base_url() ?>Country" class="text-muted"> Daftar Negara</a>
                  </li>
                </ul>
                <!--end::Breadcrumb-->
              </div>
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <?php
                  if (isset($req)) {
                  ?> <form method="POST" action="<?php echo base_url(); ?>Country/update_type">
                      <input type="hidden" name="catID" id="catID" value="<?php echo $req ?>">
                      <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header d-flex justify-content-center">
                          <h3 class="card-title">Pendaftaran Negara</h3>
                        </div>
                        <!--begin::Form-->
                        <?php
                        if (isset($err)) {
                          ...
                          ?>
                            <div class="form-group row">
                              ...
                              <div class="col-lg-6">
                                ...
                                <div class="row">
                                  <input type="text" class="form-control col-md-11" readonly name="count_id" id="count_id" value="<?php echo $key->country_code; ?>" required>
                                </div>
                              </div>
                               <div class="col-lg-6">
                              <label>Nama Negara:</label>
                              <div class="row">
                                <input type="text" class="form-control col-md-11" name="count_name" id="count_name" value="<?php echo $key->country_name; ?>" required>
                              </div>
                            </div>
                          </div>
                          <?php
                        ...
                        <div class="card-footer">
                          ...
                          <a href="<?php echo site_url(); ?>Country" class="btn btn-secondary font-weight-bolder">Cancel</a>
                        </div>
                        <!--end::Form-->
                      </div>
                      <!--end::Card-->
                  ...
                  ?>
                    <form method="POST" action="<?php echo base_url(); ?>Country/add_type">
                      <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header d-flex justify-content-center">
                        ...
                        <div class="card-body">
                          <div class="form-group row">
                              <div class="col-lg-6">
                                <label>Kode Negara:</label>
                                <div class="row">
                                <input type="text" class="form-control col-md-11" name="count_id" id="count_id" required>
                              </div>
                              </div>
                               <div class="col-lg-6">
                              <label>Nama Negara:</label>
                              <div class="row">
                                <input type="text" class="form-control col-md-11" name="count_name" id="count_name" required>
                              </div>
                            </div>
                          </div>
