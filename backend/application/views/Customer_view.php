...
<body id="bd_faqView" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
              ...
              <div class="d-flex align-items-center flex-wrap">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                  ...
                  <li class="breadcrumb-item">
                    <a href="<?php echo base_url() ?>Customer" class="text-muted">Brand</a>
                  </li>
                </ul>
                <!--end::Breadcrumb-->
              </div>
              ...
              <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                  <div class="card-title">
                    <h3 class="card-label">Brand List Table
                  </div>
                  <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="<?php echo base_url(); ?>Customer/add_type_view" class="btn btn-primary font-weight-bolder">
                ...
                <div class="card-body">
                  <table id="ProductTable" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th width="36px">No.</th>
                        <th width="185px">Brand Name</th>
                        <th width="70px">Link</th>
                        <th width="10px">Active?</th>
                        <th width="110px">Create Date</th>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td align="center">
                            <a href="<?php echo base_url(); ?>Customer/update?typeID=<?php echo $value->brandID; ?>" class="btn btn-sm btn-warning btn-text-warning btn-icon mr-2 mb-1" title="Update Data"><i class="fas fa-pencil-alt"></i> </a>

                            <a href="#" type="button" class="btn btn-sm btn-danger btn-text-danger btn-icon mr-2 mb-1" name="deleteButton" id="deleteButton" onclick="confirmation('<?php echo $value->brandID; ?>')" title="Delete Data"><i class="fas fa-trash-alt"></i></a>
                          </td>
                        </tr>
                      <?php
                      }
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>dist/js/customer.js"></script>
  <script>
...
$(".btclient-up").click(function(e) 
			{
				...
				$.ajax({
					url:base_url+"customer/move_client_up?ID_customer="+clientID+"&index="+index,
					dataType:"html",
					type:"GET",
			...
			$(".btclient-down").click(function(e) 
			{
				...
				var index=$(this).attr("data-value");
				$.ajax({
					url:base_url+"customer/move_client_down?ID_customer="+clientID+"&index="+index,
					dataType:"html",
					type:"GET",
					success: function(result)
					{
