            ...
            <div class="container">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <?php
                  if (isset($req)) {
                  ?> <form method="POST" action="<?php echo base_url(); ?>Keahlian/update_type">
                      <input type="hidden" name="keahlian_id" id="keahlian_id" value="<?php echo $req ?>">
                      <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header d-flex justify-content-center">
                          <h3 class="card-title">Pendaftaran Keahlian</h3>
                        </div>
                        <!--begin::Form-->
                        <?php
                        if (isset($err)) {
                          ...
                          ?>
                            <div class="form-group row">
                              <div class="col-lg-6">
                                ...
                                <div class="row">
                                  <input type="text" class="form-control col-md-11" name="keahlian_nm" id="keahlian_nm" value="<?php echo $key->keahlian_nm; ?>" required>
                                </div>
                              </div>
                               <div class="col-lg-6">
                              <label>Active:</label>
                        ...
                        <div class="card-footer">
                          ...
                          <a href="<?php echo site_url(); ?>Keahlian" class="btn btn-secondary font-weight-bolder">Cancel</a>
                        </div>
                        <!--end::Form-->
                      </div>
                      <!--end::Card-->
                  ...
                  ?>
                    <form method="POST" action="<?php echo base_url(); ?>Keahlian/add_type">
                      <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header d-flex justify-content-center">
                        ...
                        <div class="card-body">
                          <div class="form-group row">
                              <div class="col-lg-6">
                                ...
                                <div class="row">
                                  <input type="text" class="form-control col-md-11" name="keahlian_nm" id="keahlian_nm" required>
                                </div>
                              </div>
                               <div class="col-lg-6">
                              <label>Active:</label>
