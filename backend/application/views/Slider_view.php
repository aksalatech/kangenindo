...
<body id="bd_faqView" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
  ...
  <div class="d-flex flex-column flex-root">
          ...
          <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
              ...
              <div class="d-flex align-items-center flex-wrap mr-2">
                <h5 class="text-dark font-weight-bold my-1 mr-5">Daftar Slider</h5>
              </div>
              <div class="d-flex align-items-center flex-wrap">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                  ...
                  <li class="breadcrumb-item">
                    <a href="<?php echo base_url() ?>Slider" class="text-muted"> Slider</a>
                  </li>
                </ul>
                <!--end::Breadcrumb-->
              </div>
              ...
              <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                  <div class="card-title">
                    <h3 class="card-label">Tabel Daftar Slider
                  </div>
                  <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="<?php echo base_url(); ?>Slider/add_type_view" class="btn btn-primary font-weight-bolder">
                ...
                <div class="card-body">
                  <table id="ProductTable" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th width="36px">No.</th>
                        <th width="200px">Gambar Slider</th>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo base_url() ?>./../images/banner/<?php echo $value->imagepath ?>" target="_blank">
                              <img src="<?php echo base_url() ?>./../images/banner/<?php echo $value->imagepath ?>" width="200px" />
                            </a>
                          </td>
                          <td><?php echo $value->imagetitle; ?></td>
                          <td><?php echo $value->url_link; ?></td>
    ...
    <br />
    <span style="flex: 1;margin-left: 5px;"><?php echo $value->imageindex; ?></span>
    <br />
    <img style="width: 15%;height:15%;margin-left: 3px" src="<?php echo base_url(); ?>dist/assets/arrow-bottom.png" data-id="<?php echo $value->imageid ?>" data-value="<?php echo $value->imageindex; ?>" class="btclient-down btn btn-icon icon mini" />
                          ...
                          <td align="center">
                            <a href="<?php echo base_url(); ?>Slider/update?typeID=<?php echo $value->imageid; ?>" class="btn btn-sm btn-warning btn-text-warning btn-icon mr-2 mb-1" title="Update Data"><i class="fas fa-pencil-alt"></i> </a>
...
$(".btclient-up").click(function(e) 
			{
				...
				$.ajax({
					url:base_url+"slider/move_client_up?ID_customer="+clientID+"&index="+index,
					dataType:"html",
					type:"GET",
			...
			$(".btclient-down").click(function(e) 
			{
				...
				var index=$(this).attr("data-value");
				$.ajax({
					url:base_url+"slider/move_client_down?ID_customer="+clientID+"&index="+index,
					dataType:"html",
					type:"GET",
					success: function(result)
					{
