            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
              ...
              <div class="d-flex align-items-center flex-wrap">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                  ...
                  <li class="breadcrumb-item">
                    <a href="<?php echo base_url() ?>Slider" class="text-muted"> Daftar Slider</a>
                  </li>
                </ul>
                <!--end::Breadcrumb-->
              </div>
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <?php
                  if (isset($req)) {
                  ?> <form method="POST" action="<?php echo base_url(); ?>Slider/update_type" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="row">
                                <?php if ($key->imagepath != "") { ?>
                                  <a href="<?php echo base_url() ?>./../images/banner/<?php echo $key->imagepath ?>" target="_blank">Lihat gambar slider..</a>
                                <?php } ?>
                          ...
                          <div class="form-group row">
                            <div class="col-lg-6">
                              <label>Link</label>:
                              <div class="row">
                                <input type="text" class="form-control" name="url_link" id="url_link" value="<?php echo $key->url_link; ?>" >
                              </div>
                            </div>
                  ...
                  ?>
                    <form method="POST" action="<?php echo base_url(); ?>Slider/add_type" enctype="multipart/form-data">
                      <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header d-flex justify-content-center">
                        ...
                        <div class="card-body">
                          ...
                          <div class="form-group row">
                            <div class="col-lg-6">
                              <label>Link</label>:
                              <div class="row">
                                <input type="text" class="form-control" name="url_link" id="url_link" value="#">
                              </div>
                            </div>
                            <div class="col-lg-4 checkbox-inline">
                              <label class="checkbox checkbox-primary">
