...
<head>
  ...
  <title><?php echo APP_NAME; ?> | Daftar Events</title>
          ...
          <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
              ...
              <div class="d-flex align-items-center flex-wrap mr-2">
                <h5 class="text-dark font-weight-bold my-1 mr-5">Daftar Event</h5>
              </div>
              <div class="d-flex align-items-center flex-wrap">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                  ...
                  <li class="breadcrumb-item">
                    <a href="<?php echo base_url() ?>Events" class="text-muted"> Daftar Event</a>
                  </li>
                </ul>
                <!--end::Breadcrumb-->
              </div>
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <?php
                  if (isset($req)) {
                  ?> <form method="POST" action="<?php echo base_url(); ?>Events/update_type" enctype="multipart/form-data">
                      <input type="hidden" name="sliderID" id="sliderID" value="<?php echo $req ?>">
                      <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header d-flex justify-content-center">
                          <h3 class="card-title">Pendaftaran Slider</h3>
                        </div>
                        <!--begin::Form-->
                        <?php
                        if (isset($err)) {
                        ...
                        <div class="card-body">
                          ...
                          ?>
                            <div class="form-group row">
                              <div class="col-lg-6">
                                ...
                                <div class="row">
                                  <input type="text" class="form-control col-md-11" name="imagetitle" id="imagetitle" value="<?php echo $key->events_name; ?>" required>
                                </div>
                              </div>
                               <div class="col-lg-6">
                              <label>Gambar Event:</label>
                              <div class="row">
                                <?php if ($key->events_img != "") { ?>
                                  <a href="<?php echo base_url() ?>./../images/event/<?php echo $key->events_img ?>" target="_blank">Lihat gambar slider..</a>
                                <?php } ?>
                          ...
                          <div class="form-group row">
                            <div class="col-lg-6">
                              <label>Content:</label>
                              <div class="row">
                                <textarea rows="5" class="form-control col-md-11" name="content" id="content"><?php echo $key->events_desc; ?></textarea>
                              </div>
                            </div>
                            <!-- <div class="col-lg-6">
                              <label>Urutan</label>:
                              <div class="row">
                                <input type="number" class="form-control col-md-12" name="imageindex" id="imageindex" value="<?php echo $key->events_index; ?>" required>
                              </div>
                            </div> -->
                          </div>
                          <div class="form-group row">
                            <!-- <div class="col-lg-6">
                              <label>Url</label>:
                              <div class="row">
                                <input type="text" class="form-control" name="urllink" id="urllink" value="<?php echo $key->url_link; ?>" >
                              </div>
                            </div> -->
                        ...
                        <div class="card-footer">
                          ...
                          <a href="<?php echo site_url(); ?>Events" class="btn btn-secondary font-weight-bolder">Cancel</a>
                        </div>
                        <!--end::Form-->
                      </div>
                      <!--end::Card-->
                  ...
                  ?>
                    <form method="POST" action="<?php echo base_url(); ?>Events/add_type" enctype="multipart/form-data">
                      <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header d-flex justify-content-center">
                          <h3 class="card-title">Pendaftaran Daftar Slider</h3>
                        </div>
                        <div class="card-body">
                          <div class="form-group row">
                              <div class="col-lg-6">
                          ...
                          <div class="form-group row">
                            <div class="col-lg-6">
                              <label>url</label>:
                              <div class="row">
                                <input type="text" class="form-control" name="urlbutton" id="urlbutton">
                              </div>
                            </div>
                            <div class="col-lg-4 checkbox-inline">
                              <label class="checkbox checkbox-primary">
