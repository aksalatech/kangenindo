...
<body id="bd_user" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <!-- <a href="<?php echo base_url(); ?>User/Chg_pass?d=<?php echo $value->biodataID ?>" class="btn btn-sm btn-info btn-icon mr-2 mb-1"><i class="fas fa-lock"></i></a> -->
                              <!-- <a href="<?php echo base_url(); ?>User/Update?d=<?php echo $value->biodataID ?>" class="btn btn-sm btn-warning btn-icon mr-2 mb-1"><i class="fas fa-pencil-alt"></i></a> -->
                              <a href="#" class="btn btn-sm btn-danger btn-icon mr-2 mb-1" name="dltButton" id="dltButton" onclick="confirmation('<?php echo $value->biodataID ?>')" title="Delete Data"><i class="fas fa-trash-alt"></i></a>
                            </td>
                          </tr>
                        <?php
                          $i++;
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>dist/js/promobio.js"></script>
