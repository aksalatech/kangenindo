...
var KTCardTools = function () {
    ...
    var demo1 = function() {
        ...
        var card = new KTCard('minimize_1');
        var card = new KTCard('minimize_2');
        var card = new KTCard('minimize_3');
        var card = new KTCard('minimize_4');
        var card = new KTCard('minimize_5');
        var card = new KTCard('minimize_6');
        var card = new KTCard('minimize_7');
        var card = new KTCard('minimize_8');
        var card = new KTCard('minimize_9');
        var card = new KTCard('minimize_10');
