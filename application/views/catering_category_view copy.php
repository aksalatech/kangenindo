							...
							<div class="col-xl-4 col-sm-6 wow fadeInUp">
								<div class="single_menu">
									<div class="single_menu_img">
										<a href="<?php echo base_url(); ?>catering/detail/<?php echo $category->id_category; ?>">
											<img src="<?php echo base_url(); ?>images/catering/category/<?php echo $category->category_img; ?>" alt="menu" class="img-fluid w-100">
										</a>
									</div>
								</div>
							</div>
