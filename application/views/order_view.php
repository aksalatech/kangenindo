...
<html lang="en">
	...
	<body class="home_2">
		...
		<!--==========================
			MENU STYLE 02 START
		===========================-->
		<section class="breakfast_menu pb_120 pt_120 xs_mt_100 location-page franchise-page" style="position: relative">
			<div class="container">
				<div class="row wow fadeInUp">
					<div class="col-xl-9 m-auto">
						<div class="section_heading mb_25">
							<h2>SELECT A LITTLE INDO TOWN RESTAURANT</h2>
							<h4>Find all restaurant opening hours PLUS you can place your order for restaurant pick up or delivery.</h4>
						</div>
					</div>
				</div>
