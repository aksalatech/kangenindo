...
<header id="header" class="header">
    <div class="header-inner">
        ...
        <!-- Logo -->
        <div class="logo">
            <div class="pull-left div-settings dnone" style="position:absolute;left:3px;top:34px;z-index:999">
...
<div class="side-box" id="manage-how-box">
        ...
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td align="center" colspan="2" style="padding:12px;">
                    <i id="iIcon" class="icon-mobile" style="font-size:45px;margin-top:8px"></i>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2">
                    <textarea class="fluid" style="height:300px" maxlength="250" id="txthow_text" placeholder="How Text here.." ></textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button" id="btsave_how"  class="btn btn-black btn-padding"><i class="icon-pencil icon-white"></i>&nbsp;Create </button>
    ...
    <div class="uploadpanel dnone bnone" id="edit_how">
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td align="center" colspan="2" style="padding:12px;">
                    <i id="iedIcon" class="icon-mobile" style="font-size:45px;margin-top:8px"></i>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2">
                    <textarea class="fluid" style="height:300px" maxlength="250" id="txtedhow_text" placeholder="How Text here.." ></textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button"  class="btn btn-black btn-padding" id="btsaveed_how"><i class="icon-pencil icon-white"></i>&nbsp;Save </button>
                    ...
                    <div class="img-polaroid wid_240"  >
                        <div class="div-evt" >
                            ...
                            <span class="spleft back-white-left" style="text-align:center" data-id="<?php echo $how->ID_hows;?>">
                                <i data-id="<?php echo $how->ID_hows;?>" data-title="<?php echo $how->how_title;?>" class="btedit-how icon icon-pencil" data-pict="<?php echo $how->how_pict; ?>" data-text="<?php echo $how->how_text;?>" title="Edit How"></i><br/>
                                <br/>
                            ...
                            <span class="events_box" data-id="<?php echo $how->ID_hows;?>" data-title="<?php echo $how->how_title;?>">                               
                                <i style="font-size:30px" class="<?php echo $how->how_pict; ?>"></i>
                                <br/>
...
<div class="side-box" id="manage-testimoni-box">
    ...
    <div class="uploadpanel dnone bnone" id="upload_testimoni">
        ...
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td colspan="2">
                    <textarea class="fluid" style="height:300px" maxlength="250" id="txttestimoni_text" placeholder="Testimonial Text here.." ></textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button" id="btsave_testimoni"  class="btn btn-black btn-padding"><i class="icon-pencil icon-white"></i>&nbsp;Create </button>
    ...
    <div class="uploadpanel dnone bnone" id="edit_testimoni">
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button"  class="btn btn-black btn-padding" id="btsaveed_testimoni"><i class="icon-pencil icon-white"></i>&nbsp;Save </button>
                    ...
                    <div class="img-polaroid wid_240"  >
                        <div class="div-evt" >   
                            <span class="spleft back-white-left" style="text-align:center" data-id="<?php echo $testimoni->ID_testimoni;?>">
                                <i data-id="<?php echo $testimoni->ID_testimoni;?>" data-person="<?php echo $testimoni->person_name;?>" class="btedit-testimoni icon icon-pencil" data-corp="<?php echo $testimoni->corporation_name; ?>" data-text="<?php echo $testimoni->testimoni_text;?>" title="Edit Testimoni"></i><br/>
...
<div class="side-box" id="manage-home-box">
    ...
    <div class="uploadpanel dnone bnone" id="upload_home">
        ...
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button" id="btsave_home"  class="btn btn-black btn-padding"><i class="icon-pencil icon-white"></i>&nbsp;Create </button>
    ...
    <div class="uploadpanel dnone bnone" id="edit_home">
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button"  class="btn btn-black btn-padding" id="btsaveed_home"><i class="icon-pencil icon-white"></i>&nbsp;Save </button>
        ...
        ?>
            <div class="slide-img no-border">
                <div class="img-thumbnail wid" style="margin-bottom:-8px">
                    <div style="background-image:url('<?php echo base_url();?>image/slide/slides/<?php echo $slider->imagePath;?>')" class="div-img">
                        <span class="spleft back-white-left" style="text-align:center" data-id="<?php echo $slider->imageID;?>">
                            <i data-visible="<?php echo $slider->visible; ?>" data-html="<?php echo htmlentities($slider->content); ?>" data-name="<?php echo $slider->imageTitle; ?>" data-id="<?php echo $slider->imageID;?>" class="btedit-home icon icon-pencil" title="Edit Item"></i>
                            <br/>
                            <i data-id="<?php echo $slider->imageID;?>" class="btchangepic-home icon icon-picture" title="Edit Picture"></i><br/>
...
<div class="side-box" id="manage-why-box">
    ...
    <div class="uploadpanel dnone bnone" id="upload_why">
        ...
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td align="center" colspan="2" style="padding:12px;">
                    <i id="iwhyIcon" class="icon-laptop" style="font-size:45px;margin-top:8px"></i>
                </td>
            </tr>
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button" id="btsave_why"  class="btn btn-black btn-padding"><i class="icon-pencil icon-white"></i>&nbsp;Create </button>
    ...
    <div class="uploadpanel dnone bnone" id="edit_why">
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td align="center" colspan="2" style="padding:12px;">
                    <i id="iedwhyIcon" class="icon-laptop" style="font-size:45px;margin-top:8px"></i>
                </td>
            </tr>
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button"  class="btn btn-black btn-padding" id="btsaveed_why"><i class="icon-pencil icon-white"></i>&nbsp;Save </button>
                    ...
                    <div class="img-polaroid wid_240"  >
                        <div class="div-evt" >
                            ...
                            <span class="spleft back-white-left" style="text-align:center" data-id="<?php echo $why->ID_why;?>">
                                <i data-id="<?php echo $why->ID_why;?>" data-side="<?php echo $why->why_side;?>" data-title="<?php echo $why->why_title;?>" class="btedit-why icon icon-pencil" data-pict="<?php echo $why->why_pict; ?>" data-text="<?php echo $why->why_text;?>" title="Edit Why"></i><br/>
                                <br/>
...
<div class="side-box" id="manage-plan-box">
    ...
    <div class="uploadpanel dnone bnone" id="upload_plan">
        ...
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button" id="btsave_plan"  class="btn btn-black btn-padding"><i class="icon-pencil icon-white"></i>&nbsp;Create </button>
    ...
    <div class="uploadpanel dnone bnone" id="edit_plan">
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button"  class="btn btn-black btn-padding" id="btsaveed_plan"><i class="icon-pencil icon-white"></i>&nbsp;Save </button>
                    ...
                    <div class="img-polaroid wid_240"  >
                        <div class="div-evt" >   
                            <span class="spleft back-white-left" style="text-align:center" data-id="<?php echo $plan->ID_plan;?>">
                                <i data-id="<?php echo $plan->ID_plan;?>" data-name="<?php echo $plan->plan_name;?>" class="btedit-plan icon icon-pencil" data-currency="<?php echo $plan->currency; ?>" data-price="<?php echo $plan->price;?>" data-pereach="<?php echo $plan->per_each; ?>" title="Edit Pricing Plan"></i><br/>
        ...
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td style="padding-top:12px !important" align="right">
                    <button type="button" id="btsave_detail"  class="btn btn-black btn-padding"><i class="icon-pencil icon-white"></i>&nbsp;Create </button>
...
<div class="side-box" id="manage-category-box">
    ...
    <div class="uploadpanel dnone bnone" id="upload_category">
        ...
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button" id="btsave_category"  class="btn btn-black btn-padding"><i class="icon-pencil icon-white"></i>&nbsp;Create </button>
    ...
    <div class="uploadpanel dnone bnone" id="edit_category">
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button"  class="btn btn-black btn-padding" id="btsaveed_category"><i class="icon-pencil icon-white"></i>&nbsp;Save </button>
                    ...
                    <div class="img-polaroid wid_240"  >
                        <div class="div-evt" style="min-height:68px">
                            ...
                            <span class="spleft back-white-left" style="text-align:center" data-id="<?php echo $category->ID_category;?>">
                                <i data-id="<?php echo $category->ID_category;?>" data-visible="<?php echo $category->is_active; ?>" data-code="<?php echo $category->category_code;?>" data-name="<?php echo $category->category_name;?>" class="btedit-category icon icon-pencil" title="Edit Category"></i><br/>
...
<div class="side-box" id="manage-team-box">
    ...
    <div class="uploadpanel dnone bnone" id="upload_team">
        ...
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button" id="btsave_team"  class="btn btn-black btn-padding"><i class="icon-pencil icon-white"></i>&nbsp;Create </button>
    ...
    <div class="uploadpanel dnone bnone" id="edit_team">
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button"  class="btn btn-black btn-padding" id="btsaveed_team"><i class="icon-pencil icon-white"></i>&nbsp;Save </button>
                ...
                <div class="img-thumbnail wid" style="margin-bottom:-8px">
                    <div style="background-image:url('<?php echo base_url();?>image/team/<?php echo $team->photo_path;?>')" class="div-img">
                        <span class="spleft back-white-left" style="text-align:center" data-id="<?php echo $team->ID_team;?>">
                            <i data-name="<?php echo $team->name; ?>" data-position="<?php echo $team->position_name; ?>" data-fb="<?php echo $team->facebook_link; ?>" data-twitter="<?php echo $team->twitter_link; ?>" data-linkedin="<?php echo $team->linkedin_link; ?>" data-id="<?php echo $team->ID_team;?>" class="btedit-team icon icon-pencil" title="Edit Member"></i>
                            <br/>
                            <i data-id="<?php echo $team->ID_team;?>" class="btchangepic-team icon icon-picture" title="Edit Photo"></i><br/>
...
<div class="side-box" id="manage-portfolio-box">
    ...
    <div class="uploadpanel dnone bnone" id="upload_portfolio">
        ...
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button" id="btsave_portfolio"  class="btn btn-black btn-padding"><i class="icon-pencil icon-white"></i>&nbsp;Create </button>
    ...
    <div class="uploadpanel dnone bnone" id="edit_portfolio">
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button"  class="btn btn-black btn-padding" id="btsaveed_portfolio"><i class="icon-pencil icon-white"></i>&nbsp;Save </button>
                ...
                <div class="img-thumbnail wid" style="margin-bottom:-8px">
                    <div style="background-image:url('<?php echo base_url();?>image/portfolio/thumb/<?php echo $image->imagePath;?>')" class="div-img">
                        <span class="spleft back-white-left" style="text-align:center" data-id="<?php echo $image->imageID;?>">
                            <i data-visible="<?php echo $image->visible; ?>" data-title="<?php echo $image->imageTitle; ?>" data-category="<?php echo $image->ID_category; ?>" data-desc="<?php echo $image->imageDesc; ?>"  data-id="<?php echo $image->imageID;?>" class="btedit-portfolio icon icon-pencil" title="Edit Portfolio"></i>
                            <br/>
                            <i data-id="<?php echo $image->imageID;?>" class="btchangepic-portfolio icon icon-picture" title="Edit Image"></i><br/>
                            <i data-id="<?php echo $image->imageID;?>" class="btndetail-portfolio icon icon-documents" title="View Detail"></i><br/>
...
<div class="side-box" id="manage-detail-portfolio-box">
    ...
    <div class="uploadpanel dnone bnone" id="upload_detail_portfolio">
         <table width="100%" class="tbl-input">
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button" id="btsave_detail_portfolio"  class="btn btn-black btn-padding"><i class="icon-pencil icon-white"></i>&nbsp;Create </button>
    ...
    <div class="uploadpanel dnone bnone" id="edit_detail_portfolio">
        <table width="100%" class="tbl-input">
            ...
            <tr>
                <td style="padding-top:12px !important">
                    <button type="button"  class="btn btn-black btn-padding" id="btsaveed_detail_portfolio"><i class="icon-pencil icon-white"></i>&nbsp;Save </button>
